...
/* themes/custom/bigznews/templates/views/views-view-fields--news-tags.html.twig */
class __TwigTemplate_982a034e0c1cfda488a8d5edc484ee22 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, $context["field"], "element_type", [], "any", false, false, true, 44)) {
                ...
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["field"], "element_attributes", [], "any", false, false, true, 45), "addClass", [0 => "news_tags"], "method", false, false, true, 45), 45, $this->source), "html", null, true);
                echo ">";
    ...
    {
        return "themes/custom/bigznews/templates/views/views-view-fields--news-tags.html.twig";
    }
...
{% for field in fields -%}
  ...
  {%- if field.element_type -%}
    <{{ field.element_type }}{{ field.element_attributes.addClass(\"news_tags\") }}>{{ field.content }}</{{ field.element_type }}>
  {%- else -%}
    {{ field.content }}
  {%- endif %}
  {%- if field.wrapper_element -%}
  ...
  {%- endif %}
{%- endfor %}
", "themes/custom/bigznews/templates/views/views-view-fields--news-tags.html.twig", "C:\\xampp\\htdocs\\theme-assignment\\web\\themes\\custom\\bigznews\\templates\\views\\views-view-fields--news-tags.html.twig");
    }
